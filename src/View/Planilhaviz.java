 ...
 * @author Samuelson
 */
public class Planilhaviz extends javax.swing.JFrame {
...
print();
    ...
    private void initComponents() {
        ...
        setPreferredSize(new java.awt.Dimension(1365, 575));
    ...
    private double calculabene(double Vtran, double cestabas) {
        double result = Vtran + cestabas;
        return result;
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Planilhaviz.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Planilhaviz().setVisible(true);
            }
        });
    }
