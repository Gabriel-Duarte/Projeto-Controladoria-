 ...
 * @author Samuelson
 */
public class PlanilhaAdmIndustrial extends javax.swing.JFrame {

    /**
     * Creates new form ViewJTable
     */
    public PlanilhaAdmIndustrial() {
        initComponents();
...
//      double totS, totSM,totE, totCon, tot6, totVal,totCes,totBen, totCus ;
...
totS=0; totSM=0; totE=0; totCon=0; tot6=0; totVal=0; totCes=0; totBen=0; totCus=0;
      int id=1;
for (Funcionario p : pdao.read("adm. industrial")) {
...
totS=0; totSM=0; totE=0; totCon=0; tot6=0; totVal=0; totCes=0; totBen=0; totCus=0;
        int id=1;
for (Funcionario p : pdao.readForFuncionario(desc, "adm. industrial")) {
...
totS=0; totSM=0; totE=0; totCon=0; tot6=0; totVal=0; totCes=0; totBen=0; totCus=0;
 int id=1;
        for (Funcionario p : pdao.readForcargo(desc, "adm. industrial")) {
...
print();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PlanilhaAdmIndustrial.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PlanilhaAdmIndustrial().setVisible(true);
            }
        });
    }
