 ...
 * @author Samuelson
 */
public class PlanilhaSGQ extends javax.swing.JFrame {
 ...
 cusTot.setText(String.valueOf(totCus));
    ...
    public void readJTable() {
        ...
        for (Funcionario p : pdao.read("contabilidade")) {
...
print();
    ...
    public void readJTableForfenc(String desc) {
        ...
        for (Funcionario p : pdao.readForFuncionario(desc, "contabilidade")) {
...
print();
    ...
    public void readJTableForcar(String desc) {
        ...
        for (Funcionario p : pdao.readForcargo(desc, "contabilidade")) {
...
print();
    ...
    private void initComponents() {
        ...
        setMinimumSize(new java.awt.Dimension(1368, 530));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PlanilhaSGQ.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PlanilhaSGQ().setVisible(true);
            }
        });
    }
