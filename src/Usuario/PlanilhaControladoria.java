 ...
 * @author Samuelson
 */
public class PlanilhaControladoria extends javax.swing.JFrame {

    /**
     * Creates new form ViewJTable
     */
    public PlanilhaControladoria() {
        initComponents();
...
this.setIconImage(imagemTitulo);
 ...
 cusTot.setText(String.valueOf(totCus));
    ...
    totS=0; totSM=0; totE=0; totCon=0; tot6=0; totVal=0; totCes=0; totBen=0; totCus=0;
        ...
        for (Funcionario  p : pdao.read("controladoria")) {
...
print();
    ...
    totS=0; totSM=0; totE=0; totCon=0; tot6=0; totVal=0; totCes=0; totBen=0; totCus=0;
        ...
        for (Funcionario  p : pdao.readForFuncionario(desc,"controladoria")) {
...
print();
 ...
 public void readJTableForcar(String desc) {
        ...
        for (Funcionario  p : pdao.readForcargo(desc,"controladoria")) {
...
if (job.printDialog()) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PlanilhaControladoria.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PlanilhaControladoria().setVisible(true);
            }
        });
    }
