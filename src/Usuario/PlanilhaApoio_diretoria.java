 ...
 * @author Samuelson
 */
public class PlanilhaApoio_diretoria extends javax.swing.JFrame {

    /**
     * Creates new form ViewJTable
     */
    public PlanilhaApoio_diretoria() {
        initComponents();
...
public void textfild(){
 ...
 cusTot.setText(String.valueOf(totCus));
    ...
    public void readJTable() {
        ...
        for (Funcionario p : pdao.read("apoio diretoria")) {
...
print();
    ...
    public void readJTableForfenc(String desc) {
        ...
        for (Funcionario p : pdao.readForFuncionario(desc, "apoio diretoria")) {
...
print();
    ...
    public void readJTableForcar(String desc) {
        ...
        for (Funcionario p : pdao.readForcargo(desc, "apoio diretoria")) {
...
print();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PlanilhaApoio_diretoria.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PlanilhaApoio_diretoria().setVisible(true);
            }
        });
    }
