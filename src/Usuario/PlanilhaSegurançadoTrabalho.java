 ...
 * @author Samuelson
 */
public class PlanilhaSegurançadoTrabalho extends javax.swing.JFrame {

    /**
     * Creates new form ViewJTable
     */
    public PlanilhaSegurançadoTrabalho() {
        initComponents();
 ...
 cusTot.setText(String.valueOf(totCus));
    ...
    public void readJTable() {
        ...
        for (Funcionario p : pdao.read("segurança trabalho")) {
...
print();
    ...
    public void readJTableForfenc(String desc) {
        ...
        for (Funcionario p : pdao.readForFuncionario(desc, "segurança trabalho")) {
...
print();
    ...
    public void readJTableForcar(String desc) {
        ...
        for (Funcionario p : pdao.readForcargo(desc, "segurança trabalho")) {
...
print();
    ...
    private void initComponents() {
        ...
        setMinimumSize(new java.awt.Dimension(1367, 574));
        setPreferredSize(new java.awt.Dimension(1368, 560));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PlanilhaSegurançadoTrabalho.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PlanilhaSegurançadoTrabalho().setVisible(true);
            }
        });
    }
