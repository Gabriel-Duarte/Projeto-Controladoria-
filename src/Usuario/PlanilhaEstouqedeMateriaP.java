 ...
 * @author Samuelson
 */
public class PlanilhaEstouqedeMateriaP extends javax.swing.JFrame {

    /**
     * Creates new form ViewJTable
     */
    public PlanilhaEstouqedeMateriaP() {
        initComponents();
 ...
 cusTot.setText(String.valueOf(totCus));
    ...
    public void readJTable() {
        ...
        for (Funcionario p : pdao.read("estoque matéria prima")) {
...
print();
    ...
    public void readJTableForfenc(String desc) {
        ...
        for (Funcionario p : pdao.readForFuncionario(desc, "estoque matéria prima")) {
...
print();
    ...
    public void readJTableForcar(String desc) {
        ...
        for (Funcionario p : pdao.readForcargo(desc, "estoque matéria prima")) {
...
print();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PlanilhaEstouqedeMateriaP.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PlanilhaEstouqedeMateriaP().setVisible(true);
            }
        });
    }
