 ...
 * @author Samuelson
 */
public class PlanilhaFerramentaria extends javax.swing.JFrame {

    /**
     * Creates new form ViewJTable
     */
    public PlanilhaFerramentaria() {
        initComponents();
 ...
 cusTot.setText(String.valueOf(totCus));
    ...
    public void readJTable() {
        ...
        for (Funcionario p : pdao.read("ferramentaria")) {
...
print();
    ...
    public void readJTableForfenc(String desc) {
        ...
        for (Funcionario p : pdao.readForFuncionario(desc, "ferramentaria")) {
...
print();
    ...
    public void readJTableForcar(String desc) {
        ...
        for (Funcionario p : pdao.readForcargo(desc, "ferramentaria")) {
...
print();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PlanilhaFerramentaria.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PlanilhaFerramentaria().setVisible(true);
            }
        });
    }
