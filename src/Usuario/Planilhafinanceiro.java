 ...
 * @author Samuelson
 */
public class Planilhafinanceiro extends javax.swing.JFrame {

    /**
     * Creates new form ViewJTable
     */
    public Planilhafinanceiro() {
        initComponents();
 ...
 cusTot.setText(String.valueOf(totCus));
    ...
    public void readJTable() {
        ...
        for (Funcionario p : pdao.read("financeiro")) {
...
print();
    ...
    public void readJTableForfenc(String desc) {
        ...
        BdPermissoes pdao = new BdPermissoes();
          ...
          totS=0; totSM=0; totE=0; totCon=0; tot6=0; totVal=0; totCes=0; totBen=0; totCus=0;
        int id=1;
        for (Funcionario p : pdao.readForFuncionario(desc, "Financeiro")) {
...
print();
    ...
    public void readJTableForcar(String desc) {
        ...
        for (Funcionario p : pdao.readForcargo(desc, "Financeiro")) {
...
print();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Planilhafinanceiro.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Planilhafinanceiro().setVisible(true);
            }
        });
    }
