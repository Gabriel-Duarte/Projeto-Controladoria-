 ...
 * @author Samuelson
 */
public class PlanilhaLogistica extends javax.swing.JFrame {

    /**
     * Creates new form ViewJTable
     */
    public PlanilhaLogistica() {
        initComponents();
 ...
 cusTot.setText(String.valueOf(totCus));
    ...
    public void readJTable() {
        ...
        for (Funcionario p : pdao.read("expedição/logística")) {
...
print();
    ...
    public void readJTableForfenc(String desc) {
        ...
        for (Funcionario p : pdao.readForFuncionario(desc, "expedição/logística")) {
...
print();
    ...
    public void readJTableForcar(String desc) {
        ...
        for (Funcionario p : pdao.readForcargo(desc, "expedição/logística")) {
...
print();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PlanilhaLogistica.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PlanilhaLogistica().setVisible(true);
            }
        });
    }
