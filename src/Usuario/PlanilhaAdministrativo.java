 ...
 * @author Samuelson
 */
public class PlanilhaAdministrativo extends javax.swing.JFrame {

    /**
     * Creates new form ViewJTable
     */
    public PlanilhaAdministrativo() {
        initComponents();
 ...
 cusTot.setText(String.valueOf(totCus));
    ...
    public void readJTable() {
        ...
        totS=0; totSM=0; totE=0; totCon=0; tot6=0; totVal=0; totCes=0; totBen=0; totCus=0;
            int id=1;
        for (Funcionario p : pdao.read("administrativo")) {
...
print();
    ...
    public void readJTableForfenc(String desc) {
        ...
        for (Funcionario p : pdao.readForFuncionario(desc, "administrativo")) {
...
print();
    ...
    public void readJTableForcar(String desc) {
        ...
        for (Funcionario p : pdao.readForcargo(desc, "administrativo")) {
...
print();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PlanilhaAdministrativo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PlanilhaAdministrativo().setVisible(true);
            }
        });
    }
