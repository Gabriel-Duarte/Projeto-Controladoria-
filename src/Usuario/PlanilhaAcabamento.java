 ...
 * @author Samuelson
 */
public class PlanilhaAcabamento extends javax.swing.JFrame {

    /**
     * Creates new form ViewJTable
     */
    public PlanilhaAcabamento() {
        initComponents();
 ...
 cusTot.setText(String.valueOf(totCus));
    ...
    public void readJTable() {
        ...
        for (Funcionario p : pdao.read("acabamento")) {
...
print();
    ...
    public void readJTableForfenc(String desc) {
        ...
        totS=0; totSM=0; totE=0; totCon=0; tot6=0; totVal=0; totCes=0; totBen=0; totCus=0;
        int id=1;
        for (Funcionario p : pdao.readForFuncionario(desc, "acabamento")) {
...
print();
    ...
    public void readJTableForcar(String desc) {
        ...
        totS=0; totSM=0; totE=0; totCon=0; tot6=0; totVal=0; totCes=0; totBen=0; totCus=0;
        int id=1;
        for (Funcionario p : pdao.readForcargo(desc, "acabamento")) {
...
print();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PlanilhaAcabamento.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PlanilhaAcabamento().setVisible(true);
            }
        });
    }
